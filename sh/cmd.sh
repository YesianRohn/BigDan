...
model="deit_tiny_patch16_224" # CHANGE ME
...
python main.py --data-path ${data_path} --dataset_list ${dataset_list[3]} --model ${model} --output_dir ${output_dir_task1[3]} --batch-size ${bach_size} --epochs ${epochs} --lr ${lr} --weight-decay ${weight_decay} --test_only --resume ${resume_task1[3]}/${resume} > ${stdout_log}
